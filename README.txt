...
USAGE
    ...
    $ CUDA_VISIBLE_DEVICES=0,1,2,3 ./src/mean_field_fc.py --base_lr 1e0 \
          --batch_size 64 --epochs 80 --weight_decay 1e-5 \
          | tee "[fc-] base_lr_1e0-weight_decay_1e-5-epoch_.log"

    Step 2. Fine-tune all layers.
    $ CUDA_VISIBLE_DEVICES=0,1,2,3 ./src/mean_field_all.py --base_lr 1e-2 \
          --batch_size 64 --epochs 80 --weight_decay 1e-5 \
          --model "vgg_16-epoch_69.pth" \
          | tee "[all-] base_lr_1e-2-weight_decay_1e-3-epoch_.log"
